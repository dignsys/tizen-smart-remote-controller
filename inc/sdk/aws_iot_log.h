...
#include "log.h"
#define IOT_DEBUG	DBG
#define IOT_ERROR	ERR
#define IOT_WARN	WARN
#define IOT_INFO	INFO
...
#define FUNC_ENTRY    \
	{\
	IOT_INFO("FUNC_ENTRY:   %s L#%d \n", __func__, __LINE__);  \
	}
#define FUNC_EXIT    \
	{\
	IOT_INFO("FUNC_EXIT:   %s L#%d \n", __func__, __LINE__);  \
	}
#define FUNC_EXIT_RC(x)    \
	{\
	IOT_INFO("FUNC_EXIT:   %s L#%d Return Code : %d \n", __func__, __LINE__, x);  \
	return x; \
	}
#else
#define FUNC_ENTRY
